...
(23, 'Dumbbell', '25', 4, 'Dumbbell romanian deadlift.jpg', 3),
(24, 'Farmer Walk', '20', 5, 'Farmer Walk.jpg', 3),
(25, 'Hamstring curl', '15', 6, 'Hamstring curl.jpg', 3),
(26, 'Pullup', '10', 6, 'Pullup.jpg', 3),
(27, 'Suspended inverted Row', '14', 7, 'Suspended inverted row.jpg', 3);
...
CREATE TABLE `trainer` (
  ...
  `tran_class` varchar(40) NOT NULL,
...
(1, 'Rishabh', 'Barbell hip thrust', '9871234610'),
(2, 'Satya', 'Bench Press', '7485961020'),
(3, 'Shubhankar', 'Deadlift', '8698574852'),
(4, 'Ritika', 'Dumbbell romanian deadlift', '7788445565'),
(5, 'Ritwik', 'Farmer Walk', '7890444445'),
(6, 'Rupesh', 'Hamstring curl', '9874256451'),
(7, 'Shanu', 'Pullup', '8971226541'),
(8, 'Nimisha', 'Suspended inverted row', '9997774150');
...
(2, 'Pranav', 'pranav@yahoo.com', '12345', 70, 25, '7211240196'),
(3, 'Sahil', 'sahil@gmail.com', '12345', 64, 23, '8794510265');
